# Django settings for vpn100 project.
import os.path 
#import sae.const
...
MEDIA_URL = os.path.join(os.path.dirname(__file__), 'static')
...
SECRET_KEY = 'cj-@jv=cbgsd*4ska3=@=vrd826!o9j(9sfp46x5(2__-b%&%2'
